      ...
      <div>
        <div>
          ...
          <p>
            ...
            <a href="https://coolors.co/palettes/trending">Coolers</a>. I am an
            artist in my spare time and this application felt like something I
            would actually use. I loved their clean and intuitive UI and so I
            took up the challenge to create a mock based on some of their
            features.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>
            ...
            application prior to jumping straight into development is important.
            Also, I would use a front-end framework such as React to better
            control state within the application. Right, now application state
            not managed centrally and there is no single source of truth.
          </p>
        </div>
        <div>
          <div className={styles["faq-icon-question"]}>
          ...
          <p>
            ...
            page. Also, it would be helpful to have more detail for each colour,
            such as a name, their RGB / HSL values.
          </p>
        </div>
        <div>
          <div className={styles["faq-icon-question"]}>
